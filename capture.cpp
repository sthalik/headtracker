...
HT_API(headtracker_t*) ht_make_context(const ht_config_t* config, const char* filename)
{
    ...
    ctx->classifiers[HT_CLASSIFIER_EYE1] = ht_make_classifier("haarcascade_lefteye_2splits.xml", ht_make_rect(0.0f, 0.0f, 0.47f, 0.7f), cvSize2D32f(0.1f, 0.1f));
    ctx->classifiers[HT_CLASSIFIER_EYE2] = ht_make_classifier("haarcascade_righteye_2splits.xml", ht_make_rect(0.5f, 0.0f, 0.47f, 0.7f), cvSize2D32f(0.1f, 0.1f));
