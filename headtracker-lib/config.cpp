...
static const ht_reflection_t ht_reflection_info[] = {
    ...
    F(features_detect_threshold, float, 0.924f, 0.5f, 1.0f,
    ...
    F(keypoint_max_failed_ransac, int, 1, 0, 6,
    ...
    F(min_track_start_features, int, 10, 10, 100,
    ...
    F(ransac_posit_eps, double, 1.0e-4, 1.0e-7, 1.0e5,
    "cvPOSIT epsilon for the purpose of estimating a feature set in RANSAC."),
    //F(ransac_posit_iter, int, 75, 10, 200,
    ...
    F(filter_lumps_distance_threshold, float, 0.45f, 0.1f, 1.0f,
    ...
    F(ransac_num_iters, int, 30, 10, 100),
    F(ransac_smaller_error_preference, float, 0.25, 0.0, 10.0f,
    "How much to bias toward smaller reprojection error"),
    F(min_feature_distance, float, 3.998f, 3.00001f, 25.00001f,
    ...
    F(max_best_error, float, 20, 0, 100,
    "Max reprojection error"),
    F(pyrlk_min_eigenval, double, 5.0e-4, 1.0e-4, 1.0e-1,
    "Min eigenvals for Lukas-Kanade"),
    F(max_tracked_features, int, 125, 30, 200,
