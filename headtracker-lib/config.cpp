...
static const ht_reflection_t ht_reflection_info[] = {
    ...
    F(ransac_posit_eps, double, 1e-4, 1.0e-7, 1.0e5,
    ...
    F(keypoint_distance, float, 2.5f, 1.5f, 50.0f,
    "Minimum Euclidean distance between keypoints"),
    F(keypoint_3distance, float, 7.0f, 1.5f, 50.0f,
    "Minimum Euclidean distance between keypoints"),
    F(keypoint_10distance, float, 16.0f, 1.5f, 50.0f,
    "Minimum Euclidean distance between keypoints"),
    ...
    F(ransac_num_iters, int, 6, 5, 100,
    "RANSAC iterations per frame"),
    F(ransac_max_error, double, 12.0, 2.0, 50.0,
    ""),
    F(ransac_avg_error, double, 0.88, 0.0, 1.0,
    ""),
    F(pyrlk_min_eigenval, double, 1.0e-3, 1.0e-10, 1.0e-1,
    "Min eigenval for Lukas-Kanade"),
    F(max_best_error, double, 8, 4, 1000,
    "Max RANSAC error"),
    F(debug, bool, true, 0, 1),
    F(ransac_max_threads, int, 8, 1, 256,
    "Max threads for RANSAC"),
    F(ransac_min_features, double, 0.75, 0.1, 1.0,
