...
static const ht_reflection_t ht_reflection_info[] = {
    ...
    F(filter_lumps_feature_count_threshold, float, 0.92, 0.5f, 1.0f,
    ...
    F(pyrlk_win_size_w, int, 16, 4, 60,
    "Window size for optical flow tracking, vertical"),
    F(pyrlk_win_size_h, int, 12, 3, 45,
    ...
    F(ransac_posit_iter, int, 160, 10, 200,
    ...
    F(filter_lumps_distance_threshold, float, 0.7f, 0.1f, 1.0f,
    ...
    F(max_tracked_features, int, 70, 30, 200,
