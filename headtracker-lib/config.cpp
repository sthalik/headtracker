...
static const ht_reflection_t ht_reflection_info[] = {
    ...
    F(depth_avg_frames, int, 5, 1, 120,
    ...
    F(keypoint_quality, int, 20, 1, 60,
    "Starting keypoint quality"),
    F(keypoint_distance, float, 2.0f, 1.5f, 50.0f,
    ...
    F(ransac_smaller_error_preference, float, 0.8, 0.0, 10.0f,
    "How much to bias toward smaller reprojection error"),
    F(ransac_max_error, float, 0.91f, 0.8f, 1.5f,
    ...
    F(max_best_error, double, 80, 10, 1000,
    "Max RANSAC error"),
    F(debug, bool, true, 0, 1),
    F(ransac_max_threads, int, 2, 1, 256,
    "Max threads for RANSAC"),
    F(ransac_min_features, int, 30, 10, 100,
