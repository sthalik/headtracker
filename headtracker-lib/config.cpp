...
static const ht_reflection_t ht_reflection_info[] = {
    ...
    F(pyrlk_win_size_w, int, 23, 4, 60,
    "Window size for optical flow tracking, vertical"),
    F(pyrlk_win_size_h, int, 23, 3, 45,
    "Window size for optical flow tracking, horizontal."),
    F(ransac_posit_eps, double, 1e-4, 1.0e-10, 1.0e5,
    ...
    F(keypoint_3distance, float, 4.0f, 1.5f, 50.0f,
    "Minimum Euclidean distance between keypoints"),
    F(keypoint_10distance, float, 12.0f, 1.5f, 50.0f,
    "Minimum Euclidean distance between keypoints"),
    ...
    F(ransac_num_iters, int, 8, 5, 100,
    "RANSAC iterations per frame"),
    F(ransac_max_error, double, 12, 2.0, 50.0,
    ""),
    F(ransac_avg_error, double, 0.94, 0.0, 1.0,
    ""),
    F(pyrlk_min_eigenval, double, 1.0e-4, 1.0e-10, 1.0e-1,
    "Min eigenval for Lukas-Kanade"),
    F(max_best_error, double, 12.0, 4, 1000,
    "Max RANSAC error"),
