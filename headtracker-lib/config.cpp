...
static const ht_reflection_t ht_reflection_info[] = {
    ...
    F(ransac_posit_iter, int, 4, 10, 200,
    ...
    "Min features"),
    F(pyrlk_min_eigenval, double, 1.0-4, 1.0e-10, 1.0e-1,
