...
static const ht_reflection_t ht_reflection_info[] = {
    ...
    F(keypoint_3distance, float, 10.0f, 1.5f, 50.0f,
    "Minimum Euclidean distance between keypoints"),
    ...
    F(ransac_smaller_error_preference, float, 0.08, 0.0, 1.0f,
    "How much to bias toward smaller reprojection error"),
    F(ransac_max_error, double, 0.97f, 0.0f, 1.0f,
    ""),
    F(ransac_avg_error, double, 0.91f, 0.0f, 1.0f,
    ""),
    F(pyrlk_min_eigenval, double, 1e-3, 1.0e-10, 1.0e-1,
    "Min eigenval for Lukas-Kanade"),
    F(max_best_error, double, 8, 10, 1000,
    "Max RANSAC error"),
