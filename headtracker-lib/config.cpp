...
static const ht_reflection_t ht_reflection_info[] = {
    ...
    F(pyrlk_win_size_w, int, 27, 4, 60,
    "Window size for optical flow tracking, vertical"),
    F(pyrlk_win_size_h, int, 27, 3, 45,
    ...
    F(keypoint_distance, float, 2.8f, 1.5f, 50.0f,
    "Minimum Euclidean distance between keypoints"),
    F(keypoint_3distance, float, 8.0f, 1.5f, 50.0f,
    "Minimum Euclidean distance between keypoints"),
    ...
    F(ransac_smaller_error_preference, float, 0.008, 0.0, 1.0f,
    "How much to bias toward smaller reprojection error"),
    F(ransac_max_error, double, 0.96f, 0.0f, 1.0f,
    ""),
    F(ransac_avg_error, double, 0.91f, 0.0f, 1.0f,
    ""),
