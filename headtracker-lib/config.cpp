...
static const ht_reflection_t ht_reflection_info[] = {
    ...
    F(ransac_posit_eps, double, 1e-3, 1.0e-10, 1.0e5,
    "cvPOSIT epsilon for the purpose of estimating a feature set in RANSAC."),
    F(ransac_posit_iter, int, 10, 10, 200,
    ...
    F(ransac_max_error, double, 11, 2.0, 50.0,
    ""),
    F(ransac_avg_error, double, 0.93, 0.0, 1.0,
    ""),
    ...
    F(ransac_min_features, double, 0.7, 0.1, 1.0,
