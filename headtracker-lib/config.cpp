...
static const ht_reflection_t ht_reflection_info[] = {
    ...
    F(ransac_posit_eps, float, 1e-6, 1.0e-10, 1.0e5,
    ...
    F(keypoint_3distance, float, 5.0f, 1.5f, 50.0f,
    "Minimum Euclidean distance between keypoints"),
    F(keypoint_10distance, float, 11.0f, 1.5f, 50.0f,
    "Minimum Euclidean distance between keypoints"),
    ...
    F(ransac_num_iters, int, 15, 5, 100,
    ...
    F(max_best_error, float, 6, 4, 1000,
    "Max RANSAC error"),
    ...
    F(feature_good_nframes, int, 30, 1, 600),
    FIELD_END
};
