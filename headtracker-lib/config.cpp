...
static const ht_reflection_t ht_reflection_info[] = {
    ...
    F(keypoint_distance, float, 4.0f, 1.5f, 50.0f,
    ...
    F(ransac_max_error, double, 0.93f, 0.0f, 1.0f,
    ""),
    F(ransac_avg_error, double, 0.94f, 0.0f, 1.0f,
    ""),
    ...
    F(ransac_min_features, int, 50, 10, 100,
