...
static const ht_reflection_t ht_reflection_info[] = {
    ...
    F(ransac_posit_iter, int, 25, 10, 200,
    ...
    F(keypoint_distance, float, 3.9f, 2.0f, 50.0f,
    ...
    F(ransac_num_iters, int, 40, 10, 100,
    "RANSAC iterations per frame"),
    F(ransac_smaller_error_preference, float, 0.34, 0.0, 10.0f,
