...
static const ht_reflection_t ht_reflection_info[] = {
    ...
    F(ransac_posit_eps, double, 1e-1, 1.0e-7, 1.0e5,
    ...
    F(ransac_num_iters, int, 80, 10, 100),
    F(ransac_smaller_error_preference, float, 0.3, 0.0, 10.0f,
    "How much to bias toward smaller reprojection error"),
    F(min_feature_distance, float, 5.0f, 3.00001f, 25.00001f,
    ...
    "Min features"),
    F(pyrlk_min_eigenval, double, 1.1e-3, 1.0e-10, 1.0e-1,
