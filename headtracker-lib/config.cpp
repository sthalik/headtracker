...
static const ht_reflection_t ht_reflection_info[] = {
    ...
    F(max_tracked_features, int, 50, 30, 200,
    ...
    F(ransac_iter, int, 40, 10, 288,
    "RANSAC iterations per frame."),
    F(ransac_min_consensus, float, 0.25f, 0.2f, 0.75f,
    "Minimum RANSAC consensus size, with regards to the amount of presently tracked features"),
    F(ransac_posit_eps, double, 1.0e-3, 1.0e-7, 1.0,
    ...
    F(filter_lumps_distance_threshold, float, 0.4f, 0.1f, 1.0f,
