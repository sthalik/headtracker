...
static const ht_reflection_t ht_reflection_info[] = {
    ...
    F(ransac_max_reprojection_error, float, 12, 2, 50,
    ""),
    F(ransac_max_inlier_error, float, 12, 2, 50,
    ""),
    F(ransac_max_mean_error, float, 8, 2, 50,
    ""),
    F(ransac_abs_max_mean_error, float, 11, 2, 50,
    ""),
    F(debug, bool, 0, 0, 1,
    ""),
