...
static const ht_reflection_t ht_reflection_info[] = {
    ...
    F(keypoint_distance, float, 5.0, 1.5f, 50.0f,
    "Minimum Euclidean distance between keypoints"),
    F(keypoint_3distance, float, 8, 1.5f, 50.0f,
    "Minimum Euclidean distance between keypoints"),
    F(keypoint_10distance, float, 14, 1.5f, 50.0f,
    "Minimum Euclidean distance between keypoints"),
    ...
    ""),
    F(ransac_max_inlier_error, float, 8, 2.0, 50.0,
    ""),
    F(ransac_max_mean_error, float, 5, 2.0, 50.0,
    ""),
