...
static const ht_reflection_t ht_reflection_info[] = {
    ...
    F(keypoint_distance, float, 3.0, 1.5f, 50.0f,
    "Minimum Euclidean distance between keypoints"),
    F(keypoint_3distance, float, 5, 1.5f, 50.0f,
    "Minimum Euclidean distance between keypoints"),
    F(keypoint_10distance, float, 9, 1.5f, 50.0f,
    "Minimum Euclidean distance between keypoints"),
    ...
    F(ransac_max_reprojection_error, float, 4, 2.0, 50.0,
    ""),
    F(ransac_max_inlier_error, float, 4, 2.0, 50.0,
    ""),
    F(ransac_max_mean_error, float, 3, 2.0, 50.0,
    ""),
    F(ransac_abs_max_mean_error, float, 5, 2.0, 50.0,
    ""),
    F(pyrlk_min_eigenval, float, 1e-4, 1.0e-10, 1.0e-1,
    "Min eigenval for Lukas-Kanade"),
    F(debug, bool, true, 0, 1),
    F(ransac_min_features, float, 0.7, 0.1, 1.0,
