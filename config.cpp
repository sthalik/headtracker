...
static const ht_reflection_t ht_reflection_info[] = {
    ...
    F(keypoint_distance, float, 4.0, 1.5, 50,
    "Minimum Euclidean distance between keypoints"),
    F(keypoint_3distance, float, 9, 1.5, 50,
    "Minimum Euclidean distance between keypoints"),
    ...
    F(ransac_max_reprojection_error, float, 10, 2, 50,
    ""),
    F(ransac_max_inlier_error, float, 10, 2, 50,
    ""),
    F(ransac_max_mean_error, float, 7, 2, 50,
    ""),
    F(ransac_abs_max_mean_error, float, 10, 2, 50,
    ""),
    F(debug, bool, 1, 0, 1,
    ""),
