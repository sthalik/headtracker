...
static const ht_reflection_t ht_reflection_info[] = {
    F(classification_delay, float, 300, 200.0f, 2000.0f,
    ...
    F(max_keypoints, int, 300, 30, 400,
    "Maximum keypoints to track"),
    F(keypoint_quality, int, 31, 10, 60,
    "Starting keypoint quality"),
    F(keypoint_distance, float, 2.8, 1.5f, 50.0f,
    "Minimum Euclidean distance between keypoints"),
    F(keypoint_3distance, float, 7, 1.5f, 50.0f,
    "Minimum Euclidean distance between keypoints"),
    F(keypoint_10distance, float, 13, 1.5f, 50.0f,
    "Minimum Euclidean distance between keypoints"),
    ...
    F(ransac_max_reprojection_error, float, 8.0, 2.0, 50.0,
    ""),
    F(ransac_max_inlier_error, float, 5, 2.0, 50.0,
    ""),
    F(ransac_max_mean_error, float, 4, 2.0, 50.0,
    ""),
    F(ransac_abs_max_mean_error, float, 7, 2.0, 50.0,
    ""),
    F(pyrlk_min_eigenval, float, 1e-4, 1.0e-10, 1.0e-1,
    "Min eigenval for Lukas-Kanade"),
    F(debug, bool, true, 0, 1),
    F(ransac_min_features, float, 0.96, 0.1, 1.0,
