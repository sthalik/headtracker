...
static const ht_reflection_t ht_reflection_info[] = {
    ...
    F(keypoint_distance, float, 1.8, 1.5, 50,
    "Minimum Euclidean distance between keypoints"),
    F(keypoint_3distance, float, 4, 1.5, 50,
    "Minimum Euclidean distance between keypoints"),
    ...
    F(ransac_max_reprojection_error, float, 2.8, 2, 50,
    ""),
    F(ransac_max_inlier_error, float, 2.8, 2, 50,
    ""),
    F(ransac_max_mean_error, float, 2.3, 2, 50,
    ""),
    F(ransac_abs_max_mean_error, float, 3.5, 2, 50,
    ""),
    F(debug, bool, 0, 0, 1,
    ""),
