...
static const ht_reflection_t ht_reflection_info[] = {
    ...
    F(keypoint_distance, float, 2.5, 1.5, 50,
    "Minimum Euclidean distance between keypoints"),
    F(keypoint_3distance, float, 8, 1.5, 50,
    "Minimum Euclidean distance between keypoints"),
    ...
    F(ransac_max_reprojection_error, float, 6, 2, 50,
    ""),
    F(ransac_max_inlier_error, float, 5, 2, 50,
    ""),
    F(ransac_max_mean_error, float, 4, 2, 50,
    ""),
