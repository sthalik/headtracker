...
static const ht_reflection_t ht_reflection_info[] = {
    ...
    F(ransac_posit_eps, float, 1e-3, 1.0e-10, 1.0e5,
    ...
    "Minimum Euclidean distance between keypoints"),
    F(keypoint_10distance, float, 20.0f, 1.5f, 50.0f,
    "Minimum Euclidean distance between keypoints"),
    ...
    F(ransac_max_error, float, 7, 2.0, 50.0,
    ""),
    F(ransac_avg_error, float, 0.96, 0.0, 1.0,
    ""),
    ...
    F(ransac_min_features, float, 0.51, 0.1, 1.0,
