...
static const ht_reflection_t ht_reflection_info[] = {
    F(classification_delay, float, 2000.0f, 200.0f, 2000.0f,
    ...
    F(keypoint_3distance, float, 8.0, 1.5f, 50.0f,
    "Minimum Euclidean distance between keypoints"),
    F(keypoint_10distance, float, 19.0, 1.5f, 50.0f,
    "Minimum Euclidean distance between keypoints"),
    ...
    F(ransac_max_reprojection_error, float, 8, 2.0, 50.0,
    ""),
