...
static const ht_reflection_t ht_reflection_info[] = {
    F(classification_delay, float, 1000, 200, 2000,
    ...
    F(keypoint_distance, float, 5.01, 1.5, 50,
    ...
    F(ransac_max_reprojection_error, float, 7, 2, 50,
    ""),
    F(ransac_max_inlier_error, float, 7, 2, 50,
    ""),
    F(ransac_max_mean_error, float, 5.5, 2, 50,
    ""),
    F(ransac_abs_max_mean_error, float, 8, 2, 50,
    ""),
    F(debug, bool, 0, 0, 1,
    ""),
