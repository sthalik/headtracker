...
static const ht_reflection_t ht_reflection_info[] = {
    ...
    F(ransac_max_reprojection_error, float, 6.0, 2.0, 50.0,
    ""),
    F(ransac_max_inlier_error, float, 6.0, 2.0, 50.0,
    ""),
