...
static const ht_reflection_t ht_reflection_info[] = {
    ...
    F(keypoint_quality, int, 15, 10, 60,
    "Starting keypoint quality"),
    F(keypoint_distance, float, 2.1, 1.5, 50,
    "Minimum Euclidean distance between keypoints"),
    F(keypoint_3distance, float, 5, 1.5, 50,
    "Minimum Euclidean distance between keypoints"),
    ...
    F(ransac_max_reprojection_error, float, 3.5, 2, 50,
    ""),
    F(ransac_max_inlier_error, float, 3.5, 2, 50,
    ""),
    F(ransac_max_mean_error, float, 3, 2, 50,
    ""),
    F(ransac_abs_max_mean_error, float, 5, 2, 50,
    ""),
    F(debug, bool, 0, 0, 1,
    ""),
    F(ransac_min_features, float, 0.88, 0.1, 1,
