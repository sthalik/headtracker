...
static const ht_reflection_t ht_reflection_info[] = {
	...
	F(filter_lumps_feature_count_threshold, float, 0.6, 0.5f, 1.0f,
	...
	F(max_tracked_features, int, 52, 40, 200,
	...
	F(ransac_posit_eps, float, 0.5, 0.0001f, 10.0f,
	...
	F(keypoint_distance, float, 6.0001f, 10.0f, 50.0f,
