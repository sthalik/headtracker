...
static const ht_reflection_t ht_reflection_info[] = {
	...
	F(max_tracked_features, int, 30, 30, 200,
	...
	F(ransac_max_error, float, 0.954f, 0.9f, 1.5f,
	...
	F(min_feature_distance, float, 9.2f, 3.00001f, 25.00001f,
	...
	F(ransac_smaller_error_preference, float, 0.3f, 0.0f, 1.0f,
