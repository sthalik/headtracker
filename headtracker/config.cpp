...
static const ht_reflection_t ht_reflection_info[] = {
	...
	F(features_detect_threshold, float, 0.99f, 0.5f, 1.0f,
	...
	F(feature_quality_level, int, 10, HT_FEATURE_MIN_QUALITY_LEVEL, HT_FEATURE_MAX_QUALITY_LEVEL,
		"Maximum feature quality level compared to the strongest feature during their detection. See cvGoodFeaturesToTrack."),
	F(filter_lumps_feature_count_threshold, float, 0.85f, 0.5f, 1.0f,
	...
	F(max_detect_features, float, 4.0f, 0.1f, 4.0f,
	...
	F(ransac_best_error_importance, float, 0.05f, 0.0f, 1.0f,
	...
	F(min_feature_distance, float, 4.0000001f, 3.00001f, 15.00001f,
