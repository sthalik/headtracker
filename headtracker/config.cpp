...
static const ht_reflection_t ht_reflection_info[] = {
	...
	F(features_detect_threshold, float, 0.95f, 0.5f, 1.0f,
	...
	F(filter_lumps_feature_count_threshold, float, 0.9, 0.5f, 1.0f,
	...
	F(max_tracked_features, int, 40, 30, 200,
	...
	F(ransac_posit_eps, double, 1.0e-1, 1.0e-7, 1.0,
	...
	F(ransac_max_error, float, 0.97f, 0.9f, 1.5f,
		"Maximum error of one RANSAC iteration compared to the previous one."),
	F(filter_lumps_distance_threshold, float, 0.4f, 0.5f, 1.0f,
	...
	F(ransac_min_features, int, 5, 4, 24,
	...
	F(ransac_smaller_error_preference, float, 0.4f, 0.0f, 1.0f,
