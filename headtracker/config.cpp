...
static const ht_reflection_t ht_reflection_info[] = {
	...
	F(ransac_posit_eps, float, 0.5f, 0.0001f, 10.0f,
	...
	F(ransac_best_error_importance, float, 0.00, 0.0f, 10.0f,
	...
	F(min_feature_distance, float, 7.0001f, 3.00001f, 25.00001f,
