...
static const ht_reflection_t ht_reflection_info[] = {
	...
	F(filter_lumps_feature_count_threshold, float, 0.7, 0.5f, 1.0f,
	...
	F(max_tracked_features, int, 56, 40, 200,
	...
	F(ransac_posit_eps, double, 1.0e-4, 1.0e-7, 1.0,
	...
	F(min_feature_distance, float, 7.00001f, 3.00001f, 25.00001f,
	...
	F(keypoint_distance, float, 9.5f, 10.0f, 50.0f,
