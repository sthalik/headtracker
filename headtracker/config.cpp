...
static const ht_reflection_t ht_reflection_info[] = {
	...
	F(max_tracked_features, int, 58, 40, 200,
	...
	F(ransac_posit_eps, float, 4.0f, 0.0001f, 10.0f,
	...
	F(ransac_best_error_importance, float, 0.05f, 0.0f, 10.0f,
	...
	F(min_feature_distance, float, 8.501f, 3.00001f, 25.00001f,
	...
	F(keypoint_distance, float, 13.0001f, 10.0f, 50.0f,
