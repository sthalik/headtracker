...
static const ht_reflection_t ht_reflection_info[] = {
	...
	F(feature_quality_level, int, 2, HT_FEATURE_MIN_QUALITY_LEVEL, HT_FEATURE_MAX_QUALITY_LEVEL,
	...
	F(max_tracked_features, int, 50, 40, 200,
	...
	F(ransac_best_error_importance, float, 0.2f, 0.0f, 10.0f,
	...
	F(ransac_max_error, float, 0.95f, 0.9f, 1.001f,
	...
	F(min_feature_distance, float, 9.0001f, 3.00001f, 15.00001f,
	...
	F(keypoint_quality, int, 2, 2, 60,
		"Starting keypoint quality"),
	F(keypoint_distance, float, 15.0001f, 10.0f, 50.0f,
		"Minimum Euclidean distance between keypoints"),
	F(ransac_min_features, int, 7, 4, 24,
