...
static const ht_reflection_t ht_reflection_info[] = {
	...
	F(features_detect_threshold, float, 0.91f, 0.5f, 1.0f,
	...
	F(filter_lumps_feature_count_threshold, float, 0.84f, 0.5f, 1.0f,
		"Only filter features too close to each other if amount of features falls above this threshold."),
	F(focal_length, float, 728, 300.0f, 2000.0f,
	...
	F(max_tracked_features, int, 42, 40, 200,
	...
	F(ransac_min_consensus, float, 0.4999f, 0.2f, 0.6f,
		"Minimum RANSAC consensus size, with regards to the amount of presently tracked features"),
	F(ransac_posit_eps, float, 1.0, 0.0001f, 10.0f,
	...
	F(ransac_best_error_importance, float, 0.01f, 0.0f, 10.0f,
	...
	F(min_feature_distance, float, 6.999f, 3.00001f, 25.00001f,
	...
	F(keypoint_distance, float, 7.0001f, 10.0f, 50.0f,
