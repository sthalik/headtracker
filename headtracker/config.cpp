...
static const ht_reflection_t ht_reflection_info[] = {
	...
	F(feature_quality_level, int, 15, HT_FEATURE_MIN_QUALITY_LEVEL, HT_FEATURE_MAX_QUALITY_LEVEL,
	...
	F(max_detect_features, float, 2.0f, 0.1f, 4.0f,
	...
	F(pyrlk_win_size_w, int, 20, 4, 60,
		"Window size for optical flow tracking, vertical"),
	F(ransac_iter, int, 168, 48, 288,
	...
	F(ransac_best_error_importance, float, 0.2f, 0.0f, 1.0f,
	...
	F(filter_lumps_distance_threshold, float, 0.35f, 0.5f, 1.0f,
	...
	F(min_feature_distance, float, 2.9998f, 3.00001f, 15.00001f,
