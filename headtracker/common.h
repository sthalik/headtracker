...
#define HT_RANSAC_MAX_ERROR 0.963
...
#define HT_RANSAC_BEST_ERROR_IMPORTANCE 0.4

#define HT_FILTER_LUMPS_FEATURE_COUNT_THRESHOLD 0.75
#define HT_FILTER_LUMPS_DISTANCE_THRESHOLD 0.8

#define HT_DETECT_FEATURES_THRESHOLD 0.8
