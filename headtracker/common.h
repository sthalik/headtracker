...
#define HT_RANSAC_MAX_ERROR 0.977
...
#define HT_DETECT_POINT_DISTANCE 3.5001
...
#define HT_FILTER_LUMPS_DISTANCE_THRESHOLD 0.9

#define HT_DETECT_FEATURES_THRESHOLD 0.95
