...
#define HT_FEATURE_QUALITY_LEVEL 0.00001
...
#define HT_RANSAC_AVG_BEST_ERROR 5.69
#define HT_RANSAC_STD_DEPTH 700.0
#define HT_USE_HARRIS 0
#define HT_MIN_POINT_DISTANCE 7.5
#define HT_DETECT_POINT_DISTANCE 5.001

#define HT_MAX_DETECT_FEATURES 50
