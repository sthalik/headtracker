...
#define HT_RANSAC_MAX_ERROR 0.996f
#define HT_RANSAC_ITER 100
#define HT_RANSAC_MIN_POINTS 4
#define HT_RANSAC_MAX_BEST_ERROR 2.6

#define HT_MIN_POINT_DISTANCE 7.9
#define HT_DETECT_POINT_DISTANCE 4

#define HT_GET_FEATURES_INTERVAL_MS 25
#define HT_MAX_DETECT_FEATURES 200
#define HT_MIN_TRACK_START_POINTS 13
